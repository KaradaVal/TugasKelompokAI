import pygame
# ! deepcopy untuk mendapatkan kondisi papan permainan saat ini
import copy

#? Kelompok 3 (Game Reversi / Othello)
#? Xavier William Kurniawan – 221110776
#? Valentino Karada – 221110851
#? Frederick Yapiter – 221111050
#? Vincent Lee - 221111314
#? Davin Daniswara - 221113645

def directions(x, y, minX=0, minY=0, maxX=7, maxY=7):
    #! JUMLAH JALAN YANG VALID
    validdirections = []
...
class Othello:
    ...
    #! UNTUK DETECT INPUT SEPERTI MOUSE CLICK 
    def input(self):
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if event.button == 1:
                    ...
                    if self.gameOver:
                        #! Memulai Game Lagi jika MouseClick berada pada posisi tombol new Game
                        x, y = pygame.mouse.get_pos()
    ...
    def update(self):
        #! Check Kalau Bot masih memiliki jalan yang valid atau tidak kalau tidak permainan akan diakhiri 
...
class Grid:
    ...
    def createbgimg(self):
        #! PATTERN TAMPILAN PAPAN PERMAINAN
        gridBg = [
    ...
    #! MEMBUAT GRID UNTUK PAPAN PERMAINAN
    ...
    #! TAMPILAN SETELAH PERMAINAN SELESAI
    def endScreen(self):
    ...
    # ! Mencari tempat kosong berlawanan dengan pemain yang sedang memulai giliran.
    ...
    #! Dari List ValidCells dilakukan pengecekan apakah pemain ini memiliki langkah yang valid
    ...
    #! Memasukkan token di tempat kosong yang ditekan
